...
mndata = MNIST(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'mnist'), return_type="numpy")
...
if conf is not None:
    ...
    for i in range(10):
        for j in range(10):
            ax.text(j, i, "%d" % conf[i, j], color="black", horizontalalignment='center', verticalalignment='center')
